...
class Service extends Database{
    ...
    function getAllService(){
        $sql = parent::$connection->prepare("SELECT *, services.id as ID_service, services.status as status FROM services INNER JOIN nailtype ON services.type_id = nailtype.id INNER JOIN company ON company.id = services.company_id ORDER BY services.`id` DESC");
