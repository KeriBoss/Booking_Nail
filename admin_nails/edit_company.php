                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="time_start" id="time_start" class="form-control" value="<?=$getCompanyById[0]['time_start']?>">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="address"><b>End of work:</b></label>
                                        <input type="text" name="time_end" id="time_end" class="form-control" value="<?=$getCompanyById[0]['time_end']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hotline" value="<?=$getCompanyById[0]['hotline']?>" placeholder="Enter hotline...">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control pwd" name="password" placeholder="Enter password..." value="<?=$getCompanyById[0]['password']?>">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address" value="<?=$getCompanyById[0]['address']?>" placeholder="Enter hotline...">
                                    </div>
                                </div>
