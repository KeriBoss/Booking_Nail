                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td><a href="./edit_service.php?id=<?=$item['ID_service']?>" class="icon edit"><i class='bx bx-edit'></i></a></td>
                                <td><a onclick="if(CheckForm() == false) return false" href="./action/delete_service.php?id=<?=$item['ID_service']?>" class="icon delete"><i class='bx bxs-message-square-x'></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
