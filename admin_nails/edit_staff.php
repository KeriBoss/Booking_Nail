                        ...
                        <div class="form-group">
                            ...
                            <select name="service_id" id="set_service" class="form-control">
                                <?php foreach($getAllService as $item){ ?>
                                    <option class="serviceDiv" value="<?=$item['ID_service']?>"><?=$item['name_service']?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    for (var i = 0; i < document.querySelectorAll('.serviceDiv').length; i++) {
        if (document.querySelectorAll('.serviceDiv')[i].value == '<?= $getStaffById[0]['service_id']; ?>') {
            document.querySelectorAll('.serviceDiv')[i].selected = true;
            break;
        }
    }
</script>
