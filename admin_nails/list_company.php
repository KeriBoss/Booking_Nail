                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td>
                                    <a target="_blank" href="<?=$urlCom . $item['id']?>" style="text-decoration: underline;">Go to</a>
                                </td>
                                <td><a href="./edit_company.php?id=<?=$item['id']?>" class="icon edit"><i class='bx bx-edit'></i></a></td>
                                <td><a onclick="if(CheckForm() == false) return false" href="./action/delete_company.php?id=<?=$item['id']?>" class="icon delete"><i class='bx bxs-message-square-x'></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
